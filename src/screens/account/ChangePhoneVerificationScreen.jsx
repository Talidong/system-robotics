// src/screens/account/ChangePhoneVerificationScreen.jsx
...
export default function ChangePhoneVerificationScreen({ navigation, route }) {
  const { phone } = route.params || {};
  const [otp, setOtp] = useState('');

  const handleSubmit = () => {
    navigation.navigate(ACCOUNT_ROUTES.CHANGE_PHONE_SUCCESS, { phone });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <ResendCodeTimer onResend={() => console.log('Resend')} />
...
const styles = StyleSheet.create({
  ...
  phone: { fontSize: 13, color: '#4a7c59', fontWeight: '600', marginBottom: 32 },
